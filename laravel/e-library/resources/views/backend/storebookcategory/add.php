    ...
    <section class="content-header">
  		...
  		<ol class="breadcrumb">
        	<li><a href="<?=base_url('dashboard/index')?>"><i class="fa fa-dashboard"></i><?=$this->lang->line('dashboard')?></a></li>
  			<li><a href="<?=base_url('bookcategory/index')?>"><?=$this->lang->line('storebookcategory')?></a></li>
				...
				<div class="col-md-6">
					<form role="form" method="post" enctype="multipart/form-data">
						...
						<div class="box-footer">
							<button type="submit" class="btn btn-mytheme"><?=$this->lang->line('storebookcategory_add_book_category')?></button>
						</div>
					</form>
				</div>
			</div>
