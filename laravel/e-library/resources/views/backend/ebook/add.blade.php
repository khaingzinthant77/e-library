...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="box box-mytheme">
         <div class="row">
            <div class="col-md-6">
               <form role="form" method="post" enctype="multipart/form-data" action="{{route('e_books.store')}}">
               	@csrf
               	@method('POST')
                  <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="author">Category</label> <span class="text-red">*</span>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <textarea name="remark" value="" cols="30" rows="5" class="form-control" placeholder="Enter notes"></textarea>
                                             </div>
                  </div>
                  <div class="box-footer">
                     <button type="submit" class="btn btn-mytheme">Add Ebook</button>
                  </div>
               </form>
            </div>
         </div>
