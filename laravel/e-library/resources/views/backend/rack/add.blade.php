...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="box box-mytheme">
         <div class="row">
            <div class="col-md-6">
               <form role="form" method="post" enctype="multipart/form-data" action="{{route('rack.store')}}">
               	@csrf
               	@method('POST')
                  <div class="box-body">
                     ...
                     <div class="form-group ">
                        ...
                        <textarea name="description" value="" id="" cols="30" rows="5" class="form-control" placeholder="Enter description"></textarea>
                                             </div>
                  </div>
                  <div class="box-footer">
                     <button type="submit" class="btn btn-mytheme">Add Rack</button>
                  </div>
               </form>
            </div>
         </div>
