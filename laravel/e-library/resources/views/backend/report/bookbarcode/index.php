                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group <?=form_error('bookcategoryID') ? 'has-error' : ''?>">
                                <label><?=$this->lang->line('bookbarcodereport_book_category')?></label> <span class="text-red">*</span>
                                <?php 
                                    $bookcategoryArray[0]   = $this->lang->line('bookbarcodereport_please_select');
                        ...
                        <div class="col-sm-4">
                            <div class="form-group <?=form_error('bookID') ? 'has-error' : ''?>">
                                <label><?=$this->lang->line('bookbarcodereport_book')?></label> <span class="text-red">*</span>
                                <?php
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <button class="btn btn-mytheme" style="margin-top: 23px"><?=$this->lang->line('bookbarcodereport_get_barcode')?></button>
                                <?php if($flag) { ?>
                                    ...
                                    <a href="<?=base_url('bookbarcodereport/pdf/'.$bookcategoryID.'/'.$bookID)?>" class="btn btn-mytheme divhide" style="margin-top: 23px" target="_blank"><?=$this->lang->line('bookbarcodereport_pdf_barcode')?></a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
