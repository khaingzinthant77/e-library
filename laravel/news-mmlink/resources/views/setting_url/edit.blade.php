...
@section('content')
    ...
    <form class="form-horizontal" enctype="multipart/form-data" role="form" method="POST" action="{{ route('setting_url.update',$setting_url->id) }}">
    @csrf
    @method('PUT')
        ...
        <div class="form-group{{ $errors->has('url') ? ' has-error' : '' }}">
            ...
            <div class="col-md-9">
                <input type="text" placeholder="https://xxxxx" class="form-control" name="url" value="{{ old('url',$setting_url->url) }}">
        ...
        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="description" value="{{ old('description',$setting_url->description) }}">
