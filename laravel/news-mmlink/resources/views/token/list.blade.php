                ...
                <table id="suspend-table" class="table">
                    <thead>
                        <tr>
                            ...
                            <th width="400px;">User Id*</th>
                            <th width="300px;">Township</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$token->user_id}}</td>
                            <td>{{$token->township_name}}</td>
                            <td>{{ date('d/M/Y H:i A',strtotime($token->created_at))}}</td>
                            <td>
                                <form action="{{ route('tokendestory',$token->id) }}" method="POST" onsubmit="return confirm('Do you really want to delete?');">
                                    @csrf
                                    @method('DELETE')
